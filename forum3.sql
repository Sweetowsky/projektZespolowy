...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Sty 2019, 20:45
...
CREATE TABLE `ankieta` (
  ...
  `glosA` int(11) DEFAULT NULL,
  `glosB` int(11) DEFAULT NULL,
  `glosC` int(11) DEFAULT NULL
...
(1, 'Ankieta nr 1', 'Siemano ', 'Jakis opis', '2019-01-06 14:53:15', NULL, 1, 3, 'Tak', 'Nie', '', 4, 0, 3),
(2, 'Budowa placu zabaw', 'Czy budować plac zabaw?', '', '2019-01-06 15:28:22', NULL, 1, 3, 'Tak', 'Nie', 'Bez znaczenia', 11, 1, 7);
...
--
ALTER TABLE `ankieta`
  MODIFY `id_ankieta` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `komentarz`
  MODIFY `id_komentarz` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
